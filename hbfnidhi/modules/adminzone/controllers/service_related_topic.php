	...
	{	
	 ...
	 public  function index()
	 {
		...
		{			
	        ...
	        $this->form_validation->set_rules('faq_question','Question',"trim|required|max_length[255]|xss_clean|unique[tbl_faq.faq_question='".$this->db->escape_str($this->input->post('faq_question'))."' AND status!='2']");
			...
			if($this->form_validation->run()==TRUE)
			{
			      ...
			      $posted_data = array(
					...
					'faq_service'=>$this->input->post('service_title',TRUE),
	   ...
	   public function edit()
	   {
		   ...
		   { 
		        $this->form_validation->set_rules('faq_question','Question',"trim|required|max_length[255]|xss_clean|unique[tbl_faq.faq_question='".$this->db->escape_str($this->input->post('faq_question'))."' AND status!='2' AND faq_id!=".$Id."]");
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				$this->session->set_flashdata('success',lang('successupdate'));	
				 ...
				 redirect('adminzone/faq/'.query_string(), ''); 	
			}
