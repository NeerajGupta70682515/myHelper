          ...
          <tr>
			...
			<td align="center" >Search [ Blog Name ] 
				...
				{   
				   ...
				   if($parentid > 0 )
				   {					   
					  echo anchor("adminzone/blog/",'<span>Clear Search</span>'); 
			...
			<td><?php 
				...
				echo anchor("adminzone/blog/post/","<span>Add blog</span>",'class="btn btn-primary" style="margin-bottom:10px;"' );?></td>
		</tr>        
		</table>
		<?php echo form_close();?>
						
		
	<?php echo form_open("adminzone/blog/",'id="data_form"');?>
						...
						if(is_array($res) && ! empty($res))
		{
			...
			?> 
                      <tr class="odd" role="row">
                        <td>
							<input type="checkbox" name="arr_ids[]" value="<?php echo  $pageVal['blog_id'];?>" />
                      
						  </td>
						   <td><?php echo $pageVal['blog_title'];?></td>
						   <td><?php echo $pageVal['blog_description'];?></td>
                     
                       
						  
						
                      <td><img src="<?php echo base_url(); ?>uploaded_files/blog/<?php echo $pageVal['blog_image'];?>" height="100" width="100"></td>
                     
                      
                        <td><?php echo ($pageVal['status']==1)? "Active":"In-active";?></td>
                        <td><?php echo anchor("adminzone/blog/edit/$pageVal[blog_id]/".query_string(),'Edit'); ?>
                            </td>
