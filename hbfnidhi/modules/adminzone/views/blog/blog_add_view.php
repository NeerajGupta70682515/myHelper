<?php $this->load->view('includes/header'); ?>  
	...
	{
		echo '<li class="active"> Add Blog Details</li>';
	}   
    ?>
	...
	<?php echo form_open_multipart("adminzone/blog/post/",'class="form-horizontal "');?>  
		...
		<!--<div class="form-group">
			...
			<div class="col-sm-6">
				...
				<?php } }?>
						...
						<div class="col-sm-6">
	<input type="f" name="blog_title" class="form-control" value="<?php echo set_value('blog_title');?>" />
	...
	<input type="file" name="image" class="form-control"  />
	                                ...
	                                <div class="form-group">
										...
										<div class="col-sm-6">
											...
											<textarea name="blog_description" id="blog_description" rows="5" cols="50" class="col-xs-10 col-sm-5" ><?php echo set_value('blog_description');?></textarea>
