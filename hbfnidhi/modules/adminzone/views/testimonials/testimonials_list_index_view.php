<?php $this->load->view('includes/header'); ?>  
	...
	{
		echo '<li class="active"> Testimonials </li>';
	}   
    ?>
					...
					<div class="page-content">
						...
						<?php error_message();?>
<?php echo form_open("adminzone/testimonials/index/",'id="search_form" method="get" '); ?>
          ...
          <tr>
			...
			<td align="center" >Search [ Quest Name ] 
				...
				{   
				   ...
				   if($parentid > 0 )
				   {					   
					  echo anchor("adminzone/testimonials/",'<span>Clear Search</span>'); 
			...
			<td><?php 
				...
				echo anchor("adminzone/testimonials/post/","<span>Add Testimonials</span>",'class="btn btn-primary" style="margin-bottom:10px;"' );?></td>
		</tr>        
		</table>
		<?php echo form_close();?>
						
		
	<?php echo form_open("adminzone/testimonials/",'id="data_form"');?>
						...
						if(is_array($res) && ! empty($res))
		{
			...
			?> 
                      <tr class="odd" role="row">
                        <td>
							<input type="checkbox" name="arr_ids[]" value="<?php echo  $pageVal['testimonials_id'];?>" />
                      
						  </td>
						   <td><?php echo $pageVal['testimonials_title'];?></td>
						   <td><?php echo $pageVal['testimonials_address'];?></td>
						   <td><?php echo $pageVal['testimonials_description'];?></td>
                      <td>
                      <img src="<?php echo base_url(); ?>uploaded_files/testimonials/<?php echo $pageVal['testimonials_image'];?>" alt="" title="" height="100" width="100" />
                      </td>
     
                      
                        <td><?php echo ($pageVal['status']==1)? "Active":"In-active";?></td>
                        <td><?php echo anchor("adminzone/testimonials/edit/$pageVal[testimonials_id]/".query_string(),'Edit'); ?>
                            </td>
                      </tr>
                      <?php }?>
