<?php $this->load->view('includes/header'); ?>  
		...
		<div class="page-header">
         <h1>
            <?php echo anchor('adminzone/product','Back to List'); ?>
            <small>
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<?php echo form_open_multipart("adminzone/product/post/",'class="form-horizontal "');?>  	
		<?php 
		...
		<div class="col-sm-6">
		<input type="f" name="product_title" class="form-control" value="<?php echo set_value('product_title');?>" />
		</div>
		</div>
		...
		<div class="col-sm-6">
		<input type="f" name="product_url" class="form-control" value="<?php //echo set_value('product_url');?>" />
		</div>
		</div>-->
		...
		<textarea name="product_description" id="product_description" rows="5" cols="50" class="col-xs-10 col-sm-5" ><?php echo set_value('product_description');?></textarea>
