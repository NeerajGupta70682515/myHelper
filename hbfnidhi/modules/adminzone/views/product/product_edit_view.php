	...
	<div class="main-content-inner">
		...
		<div class="page-header">
         <h1>
			...
			<div class="col-sm-6">
			<input type="f" name="product_title" class="form-control" value="<?php echo set_value('product_title',$res['product_title']);?>" />
			</div>
			</div>
		<!--	
		<div class="form-group">
		...
		<div class="col-sm-6">
		<input type="f" name="product_url" class="form-control" value="<?php echo set_value('product_url',$res['product_url']);?>" />
		</div>
		</div>-->
		...
		<div class="form-group">
	     <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Description :</label>
				<div class="col-sm-6">
					<textarea name="product_description" id="product_description" rows="5" cols="50" class="col-xs-10 col-sm-5" ><?php echo set_value('product_description',$res['product_description']);?></textarea>
