      ...
      <div class="col-md-10 col-sm-10 col-xs-10">
        <div class="x_panel">
          ...
          <div class="x_content"> <br />
			...
			<?php echo form_open_multipart("adminzone/slide_banner/add", 'class="form-horizontal form-label-left" id="form"');?>  
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="banner_title" size="40" class="form-control col-md-7 col-xs-12" value="<?php echo $this->input->post('banner_title');?>" />
              </div>
            </div>
            <div class="form-group">
