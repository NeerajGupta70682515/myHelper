<?php $this->load->view('includes/header'); ?>  
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<?php echo form_open_multipart("adminzone/service/post/",'class="form-horizontal "');?>  	
		<?php 
		$sel = "select * from tbl_service where status ='1'"; 
		...
		<div class="col-sm-6">
		<input type="f" name="service_title" class="form-control" value="<?php echo set_value('service_title');?>" />
		</div>
		</div>
		...
		<textarea name="service_description" id="service_description" rows="5" cols="50" class="col-xs-10 col-sm-5" ><?php echo set_value('service_description');?></textarea>
