...
<?php echo form_open("adminzone/service/",'id="search_form" method="get" '); ?>
          ...
          <tr>
			...
			<td align="center" >Search [ Heading ] 
				...
				{   
				   ...
				   if($parentid > 0 )
				   {					   
					  echo anchor("adminzone/service/",'<span>Clear Search</span>'); 
			...
			<td align="right"><?php 						
				echo anchor("adminzone/service/post/","<span>Add Service</span>",'class="btn btn-primary" style="margin-bottom:10px;"' );?>
            </td>
		</tr>        
		</table>
		<?php echo form_close();?>
	...
	<?php echo form_open("adminzone/service/",'id="data_form"');?>
				<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr class="odd" role="row">
                        <td> <input type="checkbox" name="arr_ids[]" value="<?php echo  $pageVal['service_id'];?>" /></td>
						<td><?php echo $pageVal['service_title'];?></td>
						<td><?php echo $pageVal['service_description'];?></td>
                      	<td>
                      <img src="<?php echo base_url(); ?>uploaded_files/service/<?php echo $pageVal['service_image1'];?>" alt="" title="" height="100" width="100" />
                      	</td>
                      	<td>
                      <img src="<?php echo base_url(); ?>uploaded_files/service/<?php echo $pageVal['service_image2'];?>" alt="" title="" height="100" width="100" />
                      </td>
                      
                        <td><?php echo ($pageVal['status']==1)? "Active":"In-active";?></td>
                        <td><?php echo anchor("adminzone/service/edit/$pageVal[service_id]/".query_string(),'Edit'); ?>
                            </td>
                      </tr>
