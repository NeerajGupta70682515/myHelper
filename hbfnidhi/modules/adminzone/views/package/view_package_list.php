<?php $this->load->view('includes/header'); ?>  
	...
	{
		echo '<li class="active"> Package </li>';
	}   
    ?>
					...
					<div class="page-content">
						...
						<?php error_message();?>
<?php echo form_open("adminzone/package/index/",'id="search_form" method="get" '); ?>
						          <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page();?> </div>
		<table width="100%"  border="0" cellspacing="3" cellpadding="3" >
		  
          <tr>
			<td align="center" >Search [ Service Name ] 
				...
				{   
				   ...
				   if($parentid > 0 )
				   {					   
					  echo anchor("adminzone/package/",'<span>Clear Search</span>'); 
			...
			<td><?php 
				...
				echo anchor("adminzone/package/add/","<span>Add Package</span>",'class="btn btn-primary" style="margin-bottom:10px;"' );?></td>
		</tr>        
		</table>
		<?php echo form_close();?>
						
		
	<?php echo form_open("adminzone/package/",'id="data_form"');?>
						...
						if(is_array($res) && ! empty($res))
		{
			...
			?> 
                      <tr class="odd" role="row">
                        <td>
							<input type="checkbox" name="arr_ids[]" value="<?php echo  $pageVal['package_id'];?>" />
                      
						  </td>
						   <td><?php echo $pageVal['package_service'];?></td>
						   <td><?php echo $pageVal['package_name'];?></td>
                     
                       
						  
						
                      <td><?php echo $pageVal['package_price'];?></td>
                     
                      
                        <td><?php echo ($pageVal['status']==1)? "Active":"In-active";?></td>
                        <td><?php echo anchor("adminzone/package/edit/$pageVal[package_id]/".query_string(),'Edit'); ?>
                            </td>
