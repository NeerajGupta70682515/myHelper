<?php $this->load->view('includes/header'); ?>  
	...
	{
		echo '<li class="active"> Add Package Details</li>';
	}   
    ?>
	...
	<?php echo form_open("adminzone/package/add/",'class="form-horizontal "');?>  
	...
	<input type="text" name="pkg_name" placeholder="Enter Package Name" class="form-control" value="<?php echo set_value('pkg_name');?>"onkeypress="return alpha(event)" maxlength="70" required />
						</div>
					</div>
	...
	<input type="number" name="pkg_amount" placeholder="Enter Package Amount" class="form-control" value="<?php echo set_value('pkg_amount');?>"onkeypress="return alpha(event)" maxlength="6" required />
						</div>
					</div>
	                                ...
	                                <div class="form-group">
										...
										<div class="col-sm-6">
											<textarea name="description" id="faq_answer" rows="5" cols="50" class="col-xs-10 col-sm-5" ><?php echo set_value('description');?></textarea>
