          ...
          <div class="x_content"> <br />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="page_name" id="page_name" size="40" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('page_name');?>" />
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Friendly url : <span class="required">*</span> </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="friendly_url" id="friendly_url" size="40" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('friendly_url');?>">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Description: <span class="required">*</span> </label>
              <div class="col-md-9 col-sm-9 col-xs-12">
                <textarea name="page_description" rows="5" cols="50" id="page_desc" ><?=set_value('news_description');?>
</textarea>
