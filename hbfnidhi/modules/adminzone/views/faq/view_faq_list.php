<?php $this->load->view('includes/header'); ?>  
    ...
    ?>
					...
					<div class="page-content">
						...
						<?php error_message();?>
<?php echo form_open("adminzone/faq/index/",'id="search_form" method="get" '); ?>
          ...
          <tr>
			...
			<td align="center" >Search [ Quest Name ] 
				...
				{   
				   ...
				   if($parentid > 0 )
				   {					   
					  echo anchor("adminzone/faq/",'<span>Clear Search</span>'); 
			...
			<td align="right"><?php 
				...
				echo anchor("adminzone/faq/add/","<span>Add FAQ</span>",'class="btn btn-primary" style="margin-bottom:10px;"' );?></td>
		</tr>        
		</table>
		<?php echo form_close();?>
						
		
	<?php echo form_open("adminzone/faq/",'id="data_form"');?>
						...
						if(is_array($res) && ! empty($res))
		{
			...
			?> 
                      <tr class="odd" role="row">
                        <td>
							<input type="checkbox" name="arr_ids[]" value="<?php echo  $pageVal['faq_id'];?>" />
                      
						  </td>
						   <td><?php echo $pageVal['faq_service'];?></td>
						   <td><?php echo $pageVal['faq_question'];?></td>
                     
                       
						  
						
                      <td><?php echo $pageVal['faq_answer'];?></td>
                     
                      
                        <td><?php echo ($pageVal['status']==1)? "Active":"In-active";?></td>
                        <td><?php echo anchor("adminzone/faq/edit/$pageVal[faq_id]/".query_string(),'Edit'); ?>
                            </td>
