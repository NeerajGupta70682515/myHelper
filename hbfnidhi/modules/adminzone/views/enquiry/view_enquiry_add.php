...
<div class="main-content">
	...
	<?php echo form_open_multipart("adminzone/category/add/".$parent_id,'class="form-horizontal "');?>  
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input type="text" name="category_name" placeholder="Name" class="col-xs-10 col-sm-5" value="<?php echo set_value('category_name');?>" required />
										</div>
									</div>
	                           <!--     <div class="form-group">
