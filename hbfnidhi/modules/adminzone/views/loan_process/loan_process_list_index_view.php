<?php $this->load->view('includes/header'); ?>  
	...
	{
		echo '<li class="active"> Loan Process </li>';
	}   
    ?>
	</ul>
	</div>
		<div class="page-content">
            ...
            <?php error_message();?>
<?php echo form_open("adminzone/loan_process/index/",'id="search_form" method="get" '); ?>
                     
<table width="100%"  border="0" cellspacing="3" cellpadding="3" >

<tr>
<td> <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page();?> </div></td>
<td align="center" >Search [ Loan Process Name ] 
    ...
    {   
       ...
       if($parentid > 0 )
       {					   
          echo anchor("adminzone/loan_process/",'<span>Clear Search</span>'); 
...
<td align="right"><?php 
    ...
    echo anchor("adminzone/loan_process/post/","<span>Add Loan Process</span>",'class="btn btn-primary" style="margin-bottom:10px;"' );?></td>
</tr>        
</table>
<?php echo form_close();?>
            

<?php echo form_open("adminzone/loan_process/",'id="data_form"');?>
...
?> 
          <tr class="odd" role="row">
            <td>
                <input type="checkbox" name="arr_ids[]" value="<?php echo  $pageVal['loan_process_id'];?>" />
          
              </td>
               <td><?php echo $pageVal['loan_process_title'];?></td>
               <td><?php echo $pageVal['loan_process_description'];?></td>
         
           
              
            
          <td><img src="<?php echo base_url(); ?>uploaded_files/product/<?php echo $pageVal['loan_process_image'];?>" height="100" width="100"></td>
         
          
            <td><?php echo ($pageVal['status']==1)? "Active":"In-active";?></td>
            <td><?php echo anchor("adminzone/loan_process/edit/$pageVal[loan_process_id]/".query_string(),'Edit'); ?>
                </td>
