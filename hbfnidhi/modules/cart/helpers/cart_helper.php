...
<p style="float:right;"><img src="<?php echo theme_url(); ?>img/kidstuff.png" alt=""></p>
...
<div style="background:#fff; border-radius:10px; padding:10px; margin-top:10px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="color:#000;">
    <tr style="font-weight:bold; color:#fff; background:#452483">
    ...
    <tr style="border:solid 1px #ccc">
      ...
      <td align="left" style="border:#f4f4f4 1px solid; padding:10px"><p style="font-size:15px; color:#000; font-family:Arial, Helvetica, sans-serif;"><img src="<?php echo base_url();?>uploaded_files/lecture/<?php echo $val['product_image'];?>" alt="" style="float:left; margin-right:8px; width:80px; height:60px;"/><br><?php echo $val['product_name'];?></p>
...
<div style="margin-top:10px; padding:10px; color:#000; background:#f4f4f4; border:solid 1px #f4f4f4; border-radius:5px;">
      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" style="font-size:11px; line-height:16px;">
        ...
        <tr >
          ...
          <?php if($formPage==''){?>
          <img src="<?php echo theme_url(); ?>img/print-icon.png" alt="" style="vertical-align:middle; margin-right:5px;" /><a href="javascript:void(0);" onclick="print();" style="color:#1e1e1e; text-decoration:none;  font-size:12px; "><span >Print Page</span></a><?php }?></td>
...
function invoice_content1 ($ordmaster,$orddetail,$formPage='' )

{
	//echo "<pre>";
	//print_r($orddetail);die;
		$bill_info = "<p style='margin-top:10px;'><strong >$ordmaster[billing_name]</strong></p>
		$ordmaster[billing_address],
		<br />
		$ordmaster[billing_city],<br />
...
<div style="background:#fff; border-radius:10px; padding:10px; margin-top:10px;">
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="color:#000;">
    ...
    <tr style="border:solid 1px #ccc">
      <td align="left" style="border:#f4f4f4 1px solid; padding:10px"><?php echo $i;?>.</td>
      <td align="left" style="border:#f4f4f4 1px solid; padding:10px"><p style="font-size:15px; color:#000; font-family:Arial, Helvetica, sans-serif;"><img src="<?php echo base_url();?>uploaded_files/comboImg/<?php echo $val['product_image'];?>" alt="" style="float:left; margin-right:8px; width:80px; height:60px;"/><br><strong>Name </strong> :<?php echo $val['product_name'];?></p>
       <!-- <p style="padding-top:2px; font-family:Tahoma, Geneva, sans-serif; font-size:11px;"><strong>Code</strong> : <?php echo $val['product_code'];?></p>-->
        <p  style="padding-top:2px; font-family:Arial, Helvetica, sans-serif; font-size:11px; color:#acabab">&nbsp;</p></td>
      <td align="center" style="border:#f4f4f4 1px solid; padding:10px"><?php echo display_price($val['product_price']);?></td>
