...
<div class="container pt12">
  <div class="radius-5 bg-white shadow p12-16">
    ...
    <section><!--Starts-->
      ...
      <p class="fl w70 ">
        <input name="first_name" id="Name" type="text" class="form-control" value="<?php echo set_value('first_name',$mres['first_name']); ?>"/>
      </p>
      <p class="cb"></p>
  ...
  <!--        
	...
	<div class="p2">
          ...
          <p class="fl w70">
            <input type="text" name="billing_name" id="billing_name" class="form-control" value="<?php echo set_value('billing_name',$mres['billing_name']); ?>">
          </p>
          <p class="cb"></p>
        ...
        <p class="fl w70">
             <input type="text" name="billing_phone" id="billing_phone" class="form-control" value="<?php echo set_value('billing_phone',$mres['billing_phone']);?>">
        </p>
        <p class="cb"></p>
        ...
        <div class="p2">
          ...
          <p class="fl w70">
            <textarea name="billing_address" id="billing_address" rows="3" class="form-control"><?php echo set_value('billing_address',$mres['billing_address']);?></textarea>
          </p>
          <p class="cb"></p>
        ...
        <div class="p2">
          ...
          <p class="fl w70">
            <input name="billing_state" id="billing_state" type="text" class="form-control" value="<?php echo set_value('billing_state',$mres['billing_state']);?>">
          </p>
          <p class="cb"></p>
        ...
        <div class="p2">
          ...
          <p class="fl w70">
            <input name="billing_city" id="billing_city" type="text" class="form-control"  value="<?php echo set_value('billing_city',$mres['billing_city']);?>">
          </p>
          <p class="cb"></p>
        ...
        <div class="p2">
          ...
          <p class="fl w70">
            <input type="text" name="billing_zipcode" id="billing_zipcode" class="form-control" value="<?php echo set_value('billing_zipcode',$mres['billing_zipcode']);?>">
          </p>
          <p class="cb"></p>
    ...
    <div class="mt10 shadow1 p10 ml10">
      <div class="p2">
        ...
        <p class="fl w70">
          <input type="text" name="shipping_name" id="shipping_name" class="form-control" value="<?php echo set_value('shipping_name',$mres['shipping_name']); ?>">
        </p>
        <p class="cb"></p>
      ...
      <div class="p2">
        ...
        <p class="fl w70">
          <textarea name="shipping_address" id="shipping_address" rows="3" class="form-control"><?php echo set_value('shipping_address',$mres['shipping_address']);?></textarea>
        </p>
        <p class="cb"></p>
      ...
      <div class="p2">
        ...
        <p class="fl w70">
            <input type="text" name="shipping_phone" id="shipping_phone" class="form-control" value="<?php echo set_value('shipping_phone',$mres['shipping_phone']); ?>">
        </p>
        <p class="cb"></p>
      ...
      <div class="p2">
        ...
        <p class="fl w70">
          <input name="shipping_state" id="shipping_state" type="text" class="form-control" value="<?php echo set_value('shipping_state',$mres['shipping_state']); ?>" >
        </p>
        <p class="cb"></p>
      ...
      <div class="p2">
        ...
        <p class="fl w70">
          <input name="shipping_city" id="shipping_city" type="text" class="form-control" value="<?php echo set_value('shipping_city',$mres['shipping_city']); ?>" >
        </p>
        <p class="cb"></p>
      ...
      <div class="p2">
        ...
        <p class="fl w70">
          <input type="text" name="shipping_zipcode" id="shipping_zipcode" class="form-control" value="<?php echo set_value('shipping_zipcode',$mres['shipping_zipcode']); ?>">
        </p>
        <p class="cb"></p>
  ...
  <div class="fr mt15 w36">
    <p class="mt25"><img src="<?php echo theme_url(); ?>img/checkout-img.jpg" alt=""></p>
